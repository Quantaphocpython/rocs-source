...
import {
    Flame, Droplet, Trees, Mountain, Cog,
    Sword, Shield, Heart, Zap,
    BookOpen, Scroll, Sparkles, Skull
} from 'lucide-react';
import { cn } from '@/lib/utils';
import { Class, OnAttackEffect, OnDeadEffect, OnDefenseEffect, ActiveSkill } from '@/types/game';
...
const cardData = [
    {
        ...
        classes: [Class.WATER],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049294/TCG%20Battle%20Adventure/ykavqv8jwrrw4s7gemh5.png",
    ...
    },
    {
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.WOOD],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049292/TCG%20Battle%20Adventure/dqxfnzy7pxmy31divjpf.png",
        description: "A stealthy predator that lurks in the shadows of ancient forests."
    },
    {
        id: 3,
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.EARTH],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740051204/TCG%20Battle%20Adventure/btxjd57q0zdo0pj8c5ue.png",
        description: "An ancient stone construct that has protected sacred lands for millennia."
    },
    {
        id: 4,
        name: "Cursed Doll",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.WOOD],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049295/TCG%20Battle%20Adventure/byimjbt4jdxrlsluvpb7.png",
    ...
    },
    {
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.METAL],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049295/TCG%20Battle%20Adventure/rmdav3sz3idglw8n0elj.png",
        description: "A fearsome warrior clad in dark armor, harbinger of destruction."
    },
    {
        id: 6,
        name: "Forest Wraith",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.WOOD],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049298/TCG%20Battle%20Adventure/zuv1adu24pfvq6pk11tq.png",
        description: "A vengeful spirit that haunts the ancient forests, draining life from intruders."
    },
    {
        id: 7,
        name: "Molten Fiend",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.FIRE],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049290/TCG%20Battle%20Adventure/y4f0d2pntrgjhfbqpq8n.png",
        description: "A creature born of magma and flame that explodes violently when destroyed."
    },
    {
        id: 8,
        name: "Frost Revenant",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.WATER],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049298/TCG%20Battle%20Adventure/gsywiudl3ul991qgjbjy.png",
    ...
    },
    {
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.METAL],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049292/TCG%20Battle%20Adventure/u8t4oxqdpunhsbtpxyyu.png",
        description: "A legendary warrior whose mighty blade can cleave the heavens themselves."
    },
    {
        id: 10,
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.WOOD],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049292/TCG%20Battle%20Adventure/o9vyx6irjqiyonfltr5m.png",
        description: "A sinister entity that spreads disease and decay, draining life to sustain itself."
    },
    {
        id: 11,
        name: "Bone Dragon",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.EARTH],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1739799615/TCG%20Battle%20Adventure/evulnnlv4zwrrvmftmig.png",
        description: "An ancient dragon skeleton reanimated by dark magic, with armor-piercing attacks."
    },
    {
        id: 12,
        name: "Astral Phantom",
        ...
        classes: [Class.METAL],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1739799446/TCG%20Battle%20Adventure/ism9nbuglmitrjsubmo1.png",
        description: "A spectral entity that can phase between dimensions, evading attacks with ease."
    },
    {
        id: 13,
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.FIRE],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1739799266/TCG%20Battle%20Adventure/yqrbzo4klyklxhupqvur.png",
        description: "A dark mage who harnesses blood magic to drain life from enemies and heal allies."
    },
    {
        id: 14,
        ...
        activeSkill: ActiveSkill.SACRIFICE,
        classes: [Class.WOOD],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1739799181/TCG%20Battle%20Adventure/lkmxy6cguhzjdwnzkkgh.png",
        description: "A sinister puppet master who can control enemies with invisible strings."
    },
    {
        id: 15,
        name: "Obsidian Titan",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.EARTH],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1739799056/TCG%20Battle%20Adventure/f96kp7c0xoneknpixjqj.png",
        description: "A massive golem of black volcanic glass that reflects damage back to attackers."
    },
    {
        id: 16,
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.WOOD],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1739798953/TCG%20Battle%20Adventure/qkkspuiwige47obk7shd.png",
        description: "A terrifying entity that hunts prey in their dreams, striking with devastating precision."
    },
    {
        id: 17,
        ...
        activeSkill: ActiveSkill.SACRIFICE,
        classes: [Class.FIRE],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1739798578/TCG%20Battle%20Adventure/ft2siwxlhnjtuncbigdf.png",
        description: "A majestic firebird that can be reborn from its ashes when destroyed."
    },
    {
        id: 18,
        name: "Void Specter",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.METAL],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1739798389/TCG%20Battle%20Adventure/b9aacgyeclbrwqk9zgjn.png",
        description: "A ghostly entity from the void between worlds that drains life essence from its victims."
    },
    {
        id: 19,
        name: "Golem of Ruin",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.EARTH],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1739798680/TCG%20Battle%20Adventure/r3i1t2tgftgr3p6fo9i8.png",
        description: "A massive construct made from the rubble of fallen civilizations, with impenetrable defenses."
    },
    {
        id: 20,
        name: "King of Abyss",
        ...
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1739797997/TCG%20Battle%20Adventure/wsx7msv8qgeefylwbwv9.png",
        description: "The sovereign ruler of the deepest abyss, wielding both earthen might and metallic precision."
    },
    {
        id: 21,
        name: "Blazing Sword",
        ...
        description: "A fiery blade that burns its foes with every critical strike."
    },
    {
        id: 22,
        name: "Frost Shield",
        ...
        description: "An icy barrier that freezes attackers with a chilling retaliation."
    },
    {
        id: 23,
        name: "Venom Dagger",
    ...
    },
    {
        ...
        description: "A radiant entity that heals itself by draining vitality from foes."
    },
    {
        id: 25,
        ...
        description: "A frenzied warrior that sacrifices health for devastating critical strikes."
    },
    {
        id: 26,
        name: "Shadow Step",
        ...
        description: "A nimble assassin who sacrifices stamina to evade deadly blows."
    },
    {
        id: 27,
        name: "Arcane Blast",
        ...
        description: "A surge of magical energy that delivers a powerful critical hit."
    },
    {
        id: 28,
        name: "Stone Wall",
        ...
        description: "An unyielding barrier of stone that retaliates against attackers."
    },
    {
        id: 29,
        name: "Fire Elemental",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.FIRE],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049296/TCG%20Battle%20Adventure/re7ggndj9lxailwqsf2y.png",
        description: "A living flame that scorches enemies with fiery critical strikes."
    },
    {
        id: 30,
        name: "Ice Spear",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.WATER],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049290/TCG%20Battle%20Adventure/ufmrlee4xkdapmpsizuj.png",
    ...
    },
    {
        ...
        description: "A venomous creature from the abyss that drains life with each attack."
    },
    {
        id: 32,
        name: "Soul Eater",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.METAL],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049292/TCG%20Battle%20Adventure/mlqpln4i9bznjomk7muz.png",
        description: "A sinister blade that consumes the souls of its victims to grow stronger."
    },
    {
        id: 33,
        name: "Thunder Drake",
    ...
    },
    {
        ...
        description: "A dark sorcerer who sacrifices itself to resurrect fallen allies."
    },
    {
        id: 35,
        name: "Blood Reaper",
    ...
    },
    {
        ...
        description: "A towering construct of steel that punishes attackers with its resilience."
    },
    {
        id: 37,
        name: "Phantom Blade",
        ...
        description: "A ghostly sword that pierces armor with deadly critical strikes."
    },
    {
        id: 38,
        name: "Void Warden",
        ...
        activeSkill: ActiveSkill.NONE,
        classes: [Class.EARTH],
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049294/TCG%20Battle%20Adventure/fyhboeidk6dgfaldgbce.png",
        description: "A guardian of the void that reflects magical assaults back at its foes."
    },
    {
        id: 39,
        name: "Lava Behemoth",
        ...
        description: "A colossal beast of molten rock that burns and explodes with devastating force."
    },
    {
        id: 40,
        ...
        description: "A shimmering serpent of crystal that reflects damage with its radiant scales."
    }
];
...
const bossData = [
    {
        ...
        health: 80,
        attack: 10,
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740654745/TCG%20Battle%20Adventure/537804e6-d2ea-46cd-824d-3fafc5364b81_wphwqi.png",
        class: ["FIRE", "EARTH"],
        description: "Quái vật khổng lồ với cơ thể rực lửa và lớp vỏ đá cứng, tấn công bằng những đợt phun trào dung nham."
    },
    {
        id: 2,
        ...
        health: 90,
        attack: 12,
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740654745/TCG%20Battle%20Adventure/8c4d5fc2-80ab-4774-9f28-ba9e2f1e95ab_co4o0f.png",
        class: ["WATER", "METAL"],
        description: "Một con rắn biển khổng lồ với lớp vảy kim loại băng giá, có khả năng đóng băng mọi thứ xung quanh."
    },
    {
        id: 3,
        ...
        health: 100,
        attack: 14,
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740654746/TCG%20Battle%20Adventure/9e0c87bb-75ce-48f7-aea7-e66e42c1a2b8_hnojrc.png",
        class: ["WOOD", "FIRE"],
        description: "Sinh vật rừng sâu với cơ thể kết hợp giữa cây cối và ngọn lửa cháy rừng, gây sát thương diện rộng."
    },
    {
        id: 4,
        ...
        health: 85,
        attack: 11,
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740654744/TCG%20Battle%20Adventure/d2cf6175-9c3d-451c-9761-52881e750068_txlx1q.png",
        class: ["METAL", "WATER"],
        description: "Rồng bọc thép với khả năng triệu hồi bão tố, kết hợp sức mạnh kim loại và nước."
    },
    {
        id: 5,
        ...
        health: 95,
        attack: 13,
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740654745/TCG%20Battle%20Adventure/58847d12-e887-4c85-b2a0-d6e5db4299fb_z4eu5l.png",
        class: ["FIRE", "WOOD"],
        description: "Quái thú khổng lồ với rễ cây cháy âm ỉ, có sức bền và khả năng tấn công dữ dội."
    },
    {
        id: 6,
        ...
        health: 110,
        attack: 15,
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1740654746/TCG%20Battle%20Adventure/ed0eef71-531b-4dc5-84ab-59ba0b85b8af_le5dx3.png",
        class: ["EARTH", "METAL"],
        description: "Chúa tể đá từ vực sâu, với lớp giáp kim loại không thể xuyên thủng và sức mạnh hủy diệt."
    }
];
                    ...
                    <div className="flex flex-wrap gap-1">
                        {Array.isArray(card.classes) ?
                            card.classes.map((cls: string, i: number) => (
                                <div key={i} className="flex items-center gap-1 bg-black/60 px-2 py-0.5 rounded-full">
                                    {getElementIcon(cls)}
                                    <span className="text-xs">{cls}</span>
                                </div>
                            )) :
                            card.class && card.class.map((cls: string, i: number) => (
                                <div key={i} className="flex items-center gap-1 bg-black/60 px-2 py-0.5 rounded-full">
                                    {getElementIcon(cls)}
                                    <span className="text-xs">{cls}</span>
                                </div>
                    ...
                    {card.onAttackEffect && card.onAttackEffect !== "NONE" && (
                        <div className="flex items-center gap-2 p-2 rounded-lg bg-black/60 border border-red-900/30">
                            ...
                            <div className="text-xs">
                                ...
                                <span className="text-white/70">{getEffectDescription(card.onAttackEffect)}</span>
                            </div>
                        </div>
                    )}
                    ...
                    {card.onDefenseEffect && card.onDefenseEffect !== "NONE" && (
                        <div className="flex items-center gap-2 p-2 rounded-lg bg-black/60 border border-blue-900/30">
                            ...
                            <div className="text-xs">
                                ...
                                <span className="text-white/70">{getEffectDescription(card.onDefenseEffect)}</span>
                            </div>
                        </div>
                    )}
                    ...
                    {card.onDeadEffect && card.onDeadEffect !== "NONE" && (
                        <div className="flex items-center gap-2 p-2 rounded-lg bg-black/60 border border-purple-900/30">
                            ...
                            <div className="text-xs">
                                ...
                                <span className="text-white/70">{getEffectDescription(card.onDeadEffect)}</span>
                            </div>
                        </div>
                    )}
                    ...
                    {card.activeSkill && card.activeSkill !== "NONE" && (
                        <div className="flex items-center gap-2 p-2 rounded-lg bg-black/60 border border-yellow-900/30">
                            ...
                            <div className="text-xs">
                                ...
                                <span className="text-white/70">{getEffectDescription(card.activeSkill)}</span>
                            </div>
                        </div>
                    )}
                </div>
            ...
            <div className="p-4 space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    {boss.class.map((cls: string, i: number) => (
                        <div
                            key={i}
                            className={`p-3 rounded-lg bg-black/60 border ${getElementColor(cls)}`}
                        >
        ...
        <div className="space-y-8">
            <div className="bg-black/40 border border-white/10 rounded-lg p-6">
                ...
                <p className="text-white/80 mb-4">
                    Realm-of-Cards Adventure is a strategic card game where you build a deck of elemental cards and battle against powerful bosses. Each card has unique abilities and elemental affinities that interact with each other in complex ways.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-black/60 border border-white/10 rounded-lg">
                        <h4 className="text-lg font-medium text-yellow-400 mb-2">Core Gameplay</h4>
                        <ul className="space-y-2 text-white/70">
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Build a deck of 13 cards from the available card pool</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Challenge bosses on the world map with increasing difficulty</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Play cards strategically to defeat bosses before they defeat you</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                    ...
                    <div className="p-4 bg-black/60 border border-white/10 rounded-lg">
                        <h4 className="text-lg font-medium text-yellow-400 mb-2">Key Features</h4>
                        <ul className="space-y-2 text-white/70">
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Five elemental types with unique strengths and weaknesses</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Special card effects that trigger on attack, defense, or death</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
            ...
            <div className="bg-black/40 border border-white/10 rounded-lg p-6">
                ...
                <div className="space-y-4">
                    <div className="p-4 bg-black/60 border border-white/10 rounded-lg">
                        <h4 className="text-lg font-medium text-yellow-400 mb-2">1. Deck Building</h4>
                        <p className="text-white/70 mb-2">
                            Before entering battle, you must build a deck of 13 cards. Each card has a limit on how many copies you can include in your deck.
                        </p>
                        <ul className="space-y-2 text-white/70">
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Choose from pre-built decks or create your own custom deck</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Balance your deck with different card types and elemental affinities</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                    ...
                    <div className="p-4 bg-black/60 border border-white/10 rounded-lg">
                        <h4 className="text-lg font-medium text-yellow-400 mb-2">2. Map Navigation</h4>
                        <p className="text-white/70 mb-2">
                            After building your deck, you'll navigate the world map to select a boss to challenge.
                        </p>
                        <ul className="space-y-2 text-white/70">
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Each boss has unique elemental affinities and abilities</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Study boss weaknesses and build decks to exploit them</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                    ...
                    <div className="p-4 bg-black/60 border border-white/10 rounded-lg">
                        <h4 className="text-lg font-medium text-yellow-400 mb-2">3. Battle Phase</h4>
                        <p className="text-white/70 mb-2">
                            During battle, you and the boss take turns playing cards and attacking.
                        </p>
                        <ul className="space-y-2 text-white/70">
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                            ...
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>The boss will attack your cards or you directly if you have no cards</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                    ...
                    <div className="p-4 bg-black/60 border border-white/10 rounded-lg">
                        <h4 className="text-lg font-medium text-yellow-400 mb-2">4. Victory Conditions</h4>
                        <p className="text-white/70 mb-2">
            ...
            <div className="bg-black/40 border border-white/10 rounded-lg p-6">
                    ...
                    <div className="p-4 bg-black/60 border border-red-900/30 rounded-lg">
                        ...
                        <ul className="space-y-2 text-white/70">
                            <li className="flex items-start gap-2">
                                ...
                                <div>
                                    <span className="font-medium text-red-400">Critical Strike: </span>
                        ...
                        <ul className="space-y-2 text-white/70">
                            <li className="flex items-start gap-2">
                                ...
                                <div>
                                    ...
                                    <span>Reflects 2 damage back to the attacker when attacked</span>
                                </div>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul className="space-y-2 text-white/70">
                            <li className="flex items-start gap-2">
                                ...
                                <div>
                                    ...
                                    <span>Deals 3 damage to the enemy when the card is destroyed</span>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="p-4 bg-black/60 border border-yellow-900/30 rounded-lg">
                        ...
                        <ul className="space-y-2 text-white/70">
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <div>
                                    <span className="font-medium text-yellow-400">Sacrifice: </span>
                ...
                <div className="p-4 bg-black/60 border border-white/10 rounded-lg">
                    <h4 className="text-lg font-medium text-yellow-400 mb-2">Element Interactions</h4>
                    <p className="text-white/70 mb-3">
                        Each card belongs to one or more elemental types, which have strengths and weaknesses against other elements.
                    </p>
            ...
            <div className="bg-black/40 border border-white/10 rounded-lg p-6">
                <h3 className="text-xl font-bold text-yellow-400 mb-4">Strategy Tips</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-black/60 border border-white/10 rounded-lg">
                        <h4 className="text-lg font-medium text-yellow-400 mb-2">Deck Building</h4>
                        <ul className="space-y-2 text-white/70">
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Balance your deck with different card types and elemental effects</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Consider stamina costs when building your deck</span>
                    ...
                    <div className="p-4 bg-black/60 border border-white/10 rounded-lg">
                        <h4 className="text-lg font-medium text-yellow-400 mb-2">Battle Tactics</h4>
                        <ul className="space-y-2 text-white/70">
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                            ...
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
                                <span>Save high-damage cards for when the boss is vulnerable</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="h-1.5 w-1.5 rounded-full mt-1.5 bg-yellow-400" />
...
export default function WikiPage() {
    ...
    const handleSearch = (term: string) => {
        ...
        const filtered = cardData.filter(card => {
            const matchesSearch = card.name.toLowerCase().includes(term.toLowerCase()) ||
        ...
        const filteredBoss = bossData.filter(boss =>
    ...
    const handleElementFilter = (element: string | null) => {
        ...
        const filtered = cardData.filter(card => {
            ...
            const matchesElement = element && element !== elementFilter ?
                Array.isArray(card.classes) ?
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="flex flex-wrap justify-center gap-2 mb-8">
                            <Button
                                ...
                                className={cn(
                                    ...
                                    elementFilter === "FIRE" && "bg-red-900/20 border-red-400/50 text-red-400"
                                )}
                            ...
                            <Button
                                ...
                                className={cn(
                                    ...
                                    elementFilter === "WATER" && "bg-blue-900/20 border-blue-400/50 text-blue-400"
                                )}
                            ...
                            <Button
                                ...
                                className={cn(
                                    ...
                                    elementFilter === "WOOD" && "bg-green-900/20 border-green-400/50 text-green-400"
                                )}
                            ...
                            <Button
                                ...
                                className={cn(
                                    ...
                                    elementFilter === "EARTH" && "bg-yellow-900/20 border-yellow-400/50 text-yellow-400"
                                )}
                            ...
                            <Button
                                ...
                                className={cn(
                                    ...
                                    elementFilter === "METAL" && "bg-gray-700/20 border-gray-400/50 text-gray-400"
                                )}
                        ...
                        <Tabs defaultValue="cards" className="w-full">
                            <TabsList className="w-full max-w-md mx-auto grid grid-cols-3 mb-8">
                                <TabsTrigger value="cards" className="text-white data-[state=active]:bg-yellow-900/50 data-[state=active]:text-yellow-400">
                                    Cards
                                </TabsTrigger>
                                <TabsTrigger value="bosses" className="text-white data-[state=active]:bg-yellow-900/50 data-[state=active]:text-yellow-400">
                                    Bosses
                                </TabsTrigger>
                                <TabsTrigger value="mechanics" className="text-white data-[state=active]:bg-yellow-900/50 data-[state=active]:text-yellow-400">
                                    Game Mechanics
                                </TabsTrigger>
                            </TabsList>
                            ...
                            <TabsContent value="cards">
                                {filteredCards.length > 0 ? (
                                    ...
                                    <div className="text-center py-12">
                                        <p className="text-white/70">No cards found matching your search criteria.</p>
                                    </div>
                                )}
                            </TabsContent>
                            ...
                            <TabsContent value="bosses">
                                {filteredBosses.length > 0 ? (
                                    ...
                                    <div className="text-center py-12">
                                        <p className="text-white/70">No bosses found matching your search criteria.</p>
                                    </div>
                                )}
                            </TabsContent>
