        ...
        <section id="home" className="min-h-screen flex items-center relative overflow-hidden">
            <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    >
                        A cutting-edge turn-based card game that fuses strategic depth with immersive gameplay. Assemble your deck from diverse elemental cards and face off against fearsome monsters across dynamic stages.
                    </motion.p>
                    ...
                    >
                        ...
                        >
                            <div className="absolute inset-0 bg-gradient-to-r from-yellow-400/20 to-violet-500/20 group-hover:opacity-100 opacity-0 transition-opacity" />
                            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(234,179,8,0.4),transparent_70%)] opacity-0 group-hover:opacity-100 transition-opacity" />
                        ...
                        <Button
                            size="lg"
                            variant="outline"
                            className="text-lg border-white hover:bg-white/10 text-white rounded-full relative group overflow-hidden"
                            ...
                            <div className="relative w-64 h-64 md:w-96 md:h-96">
                                ...
                                {Array.from({ length: 15 }).map((_, i) => (
                                    <motion.div
                                        ...
                                        style={{
                                            background: i % 3 === 0 ? "rgb(234, 179, 8)" : i % 3 === 1 ? "rgb(139, 92, 246)" : "rgb(234, 88, 12)",
                                            left: "50%",
                                            top: "50%",
                                        }}
                                        animate={{
