            ...
            <Link href={href}>
                ...
                >
                  ...
                  transparent
                    ...
                    {/* Content */}
                    <div className="relative h-full flex flex-col justify-end p-5 gap-4"> {/* Reduced padding and gap */}
                        {/* Category Badge */}
                        <div
                        ...
                        >
                            <h3 className="text-lg font-bold text-white"> {/* Reduced font size */}
                                {title}
                            </h3>
                            <p className="text-sm text-white/70 line-clamp-2"> {/* Reduced font size and lines */}
                                {description}
                            </p>
...
export function FeatureSection() {
    ...
    const features = [
        {
            ...
            imageUrl: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049293/TCG%20Battle%20Adventure/vnwlzhguts8rfc7jkhnp.png",
            title: "Harness the Power of Flames",
            description: "Fire cards deliver devastating attacks with high damage output and critical strike abilities.",
        ...
        },
        {
            ...
            description: "Water cards excel in healing and lifesteal effects, providing sustainability in longer battles.",
            imageUrl: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049294/TCG%20Battle%20Adventure/vgsemseiixtxtyjjfo1v.png",
        ...
        },
        {
            ...
            description: "Earth cards feature high health and defensive abilities, creating impenetrable walls against enemy attacks.",
            imageUrl: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049298/TCG%20Battle%20Adventure/r9ahkormzgxdmlfwuj9s.png",
        ...
        },
        {
            ...
            description: "Wood cards balance offense and defense with regenerative abilities and sustained damage output.",
            imageUrl: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049296/TCG%20Battle%20Adventure/lm03b601m6xeobc7wczu.png",
        ...
        },
        {
            ...
            description: "Metal cards combine high attack power with armor effects, creating formidable offensive threats.",
            imageUrl: "https://res.cloudinary.com/dlotuochc/image/upload/v1740049296/TCG%20Battle%20Adventure/bwmtrdybdv8wnz3zycg7.png",
    ...
    return (
        <section id="features" className="relative flex w-full flex-col items-center gap-10 py-24 overflow-hidden"> {/* Reduced vertical spacing */}
            {/* Background Effects */}
            ...
            >
                <h2 className="text-4xl font-bold bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text text-transparent"> {/* Reduced font size */}
                    Elemental Powers
                </h2>
                <Balancer className="text-lg text-white/80"> {/* Reduced font size */}
                    Master the five elements and harness their unique strengths to build the perfect deck for your playstyle.
                </Balancer>
            </motion.header>

            <div className="w-full max-w-[1200px] mx-auto px-4"> {/* Reduced max width */}
                <div
            ...
            >
                <div className="bg-black/30 backdrop-blur-sm border border-white/20 rounded-xl p-6">
                    <h3 className="text-xl font-bold text-yellow-400 mb-4 text-center">Element Interaction Guide</h3>
