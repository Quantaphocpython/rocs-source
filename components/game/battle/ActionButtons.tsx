...
export function ActionButtons({
  ...
  return (
    <div className="flex justify-end gap-6 p-6 bg-gradient-to-t from-gray-900 to-black/50 border-t border-yellow-500/50 shadow-[0_0_15px_rgba(234,179,8,0.2)]">
      <Button
        className={`font-semibold py-3 px-8 rounded-lg transition-all duration-200 ${isPlayerTurn && selectedCard !== null && targetSlot !== null
      ...
      <Button
        className={`font-semibold py-3 px-8 rounded-lg transition-all duration-200 ${isPlayerTurn
