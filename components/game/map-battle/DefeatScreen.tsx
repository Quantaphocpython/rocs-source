...
export function DefeatScreen({ boss, onRetry, onReturnToMap }: DefeatScreenProps) {
    return (
        <div className="min-h-screen bg-black flex items-center justify-center">
            <div className="absolute inset-0 overflow-hidden">
                ...
                {Array.from({ length: 10 }).map((_, i) => (
                    <motion.div
                        ...
                        style={{
                            background: 'radial-gradient(circle, rgba(120,20,20,0.3) 0%, rgba(0,0,0,0) 70%)'
                        }}
                        initial={{
            ...
            >
                ...
                >
                    ...
                    <p className="text-xl text-red-200 mb-6">{boss.name} has bested you!</p>
                </motion.div>
                ...
                >
                    ...
                    <div className="bg-black/40 border border-red-900/30 rounded-lg p-4 mb-6">
                        <h3 className="text-lg font-medium text-red-400 mb-2">Battle Results</h3>
                        <p className="text-red-200/80 mb-4">
                            Don't give up! Adjust your strategy and try again. Consider using cards that counter {boss.name}'s elements.
                        </p>
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div className="bg-black/30 p-3 rounded-lg">
                                ...
                                <p className="text-lg font-bold text-red-400">{boss.class.join(', ')}</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
